...
class Document(JSObject):
    def getElementById(self, id: str) -> Optional[JSObject]: ...
    def createElement(self, tagName: str) -> JSObject: ...
    def querySelector(self, selectors: str) -> Optional[JSObject]: ...
    def querySelectorAll(self, selectors: str) -> Sequence[JSObject]: ...
